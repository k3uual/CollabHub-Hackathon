<html>
    ...
    <?php
        ...
        while($row = mysqli_fetch_array($cmd)) {
            ?>
            <div class="card" onclick="document.location.href = 'F_edit.php?id=<?php echo $row['id'];?>'">
                <div class="section imgsec">
                    ...
                    ?>
                    <img class="eimg" src="../display_img.php?userid=<?php echo $row['id'];?>&usertype=students" alt="Student Image">
                    <?php }?>
                </div>
                <div class="section detsec">
                    <div class="ele ename"><b><?php echo $row['name'];?></b></div>
                    <div class="details">
                        <div class="ele">ID: <?php echo $row['id']?></div>
